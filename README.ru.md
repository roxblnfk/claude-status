...
запускаться. В списке — релизы, о которых знает сама программа, и все модели, на
которых вы уже работали, так что вышедшая позже программы тоже там будет.

Кнопка ◎ рядом с обновлением сворачивает окно в квадратную плашку поверх всех
окон: четыре кольца — пятичасовая сессия, норма на сегодня, неделя и лимит по
модели, последнее — своим цветом. На каждом та же риска, что и на полосках: где
был бы расход при ровном темпе. Норма, потраченная сверх положенного, уходит на
второй круг. Плашка перетаскивается мышью и тянется за край, двойной клик или
Esc возвращают обычное окно. И плашка, и окно открываются там же и такого же
размера, как их оставили. Насколько плашка бледнеет без фокуса — в **Настройках
→ Программа**.
